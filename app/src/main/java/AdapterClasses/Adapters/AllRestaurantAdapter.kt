...
) : RecyclerView.Adapter<AllRestaurantAdapter.ViewHolder>(),Filterable {

    private var filteredList: List<AllRestaurant>? = allrestuent
        ...
        holder.image.setOnClickListener {
            ...
            if (restaurant != null) {
                if (!restaurant.restaurantId.isNullOrEmpty()) {
                    ...
                    Toast.makeText(context, "Error: Restaurant ID is missing", Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                filteredList = if (query.isNullOrEmpty()) {
                    ...
                    allrestuent?.filter {
                        it.restaurantName.lowercase(Locale.getDefault()).contains(query) ||
                                it.restaurantFoodType.lowercase(Locale.getDefault()).contains(query)
                    }
                }
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                filteredList = results?.values as List<AllRestaurant>
